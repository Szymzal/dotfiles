...
myLayout = avoidStruts ( grid ||| tiled ||| monocle ) ||| fullscreen
	where
		tiled	= named "Stack" $ spacing mySpacing $ ResizableTall 1 (3/100) (1/2) []
		grid	= named "Grid" $ spacing mySpacing $ Grid (16/10)
